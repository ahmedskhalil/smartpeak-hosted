...
#minikube start --cpus 4 --memory 6144 -p sp-hosted --namespace sp-hosted-ns --hyperv-virtual-switch "smartpeak-storage-switch" --v=4 --mount --mount-string="/Users/mk/dev/data:/data"
...
# /Users/mk/dev/data/LCMS_MRM_Unknowns